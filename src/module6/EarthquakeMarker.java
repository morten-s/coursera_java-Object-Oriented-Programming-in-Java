...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public EarthquakeMarker (PointFeature feature, PImage img) 
	{
		...
		//
		this.radius = 1.75f*getMagnitude()/2.5f;
		imageM = img;
	}
	...
	public void drawMarker(PGraphics pg, float x, float y) {
		...
		{	
	    	...
	    	Location upperLocation = GeoUtils.getDestinationLocation(centerLocation, 0, (float) this.threatCircle());
	    	ScreenPosition center = EarthquakeCityMap.map.getScreenPosition(centerLocation);
	    	ScreenPosition upper = EarthquakeCityMap.map.getScreenPosition(upperLocation);
	    	//float radius = PApplet.dist(center.x, center.y, upper.x, upper.y);
	    	//pg.ellipse(center.x, center.y, upper.y-center.y, upper.y-center.y);
	    	pg.ellipse(x, y, (upper.y-center.y)*2, (upper.y-center.y)*2);
